...
// config pesanan
    const firebaseConfig = {
        ...
        const url2 = `https://v2.apigames.id/merchant/M230421YOYQ2073CP/cek-username/mobilelegend?user_id=${inputId}${inputServer}&signature=acb07108bf96ce90b7327cbf5f72f6be`;
